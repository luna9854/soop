...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="lg:hidden relative z-[60] p-2 text-white hover:bg-white/10 rounded-lg transition-colors"
      ...
      {/* Mobile Menu - 헤더 밖으로 분리 */}
      <div
        className={cn(
          "lg:hidden fixed inset-0 z-[55] bg-black/95 backdrop-blur-xl transition-all duration-500",
          isMobileMenuOpen
